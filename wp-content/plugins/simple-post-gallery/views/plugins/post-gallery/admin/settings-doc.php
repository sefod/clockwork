...
>
    ...
    <div class="container">
        ...
        <div id="usage">
            ...
            <p>
                <img src="<?php echo asset_url( '/../../../../images/documentation/customization-gallery1.jpg', __FILE__ )?>" alt="gallery 2"/>
            </p>
            <p><?php _e( 'Click the "Add Image" button to selected and add images to the gallery.', 'post-gallery' ) ?></p>
            <p>
                <img src="<?php echo asset_url( '/../../../../images/documentation/customization-gallery2.jpg', __FILE__ )?>" alt="gallery 2"/>
            </p>
            ...
            <p>
                <img src="<?php echo asset_url( '/../../../../images/documentation/customization-gallery3.jpg', __FILE__ )?>" alt="gallery 3"/>
            </p>
        ...
        <div id="customization">
            ...
            <p>
                <code>
                    wp-content/plugins/simple-post-gallery/views
                </code>
            </p>
            <p>
            ...
            <p>
                <img src="<?php echo asset_url( '/../../../../images/documentation/customization-example1.jpg', __FILE__ )?>" alt="example 1"/>
            </p>
            <p>
                <?php _e( 'Then we paste them over (with the same path structure) into our theme:', 'post-gallery' ) ?>
            </p>
            <p>
                <img src="<?php echo asset_url( '/../../../../images/documentation/customization-example2.jpg', __FILE__ )?>" alt="example 2"/>
            </p>
        ...
        <div id="settings">
            ...
            <p>
                <?php echo sprintf(
                    __( 'Configure your image resolution (sizes) settings at <a href="%s">Settings > Media</a>.', 'post-gallery' ),
    ...
    <div class="credits text-center">
        ...
        <a href="http://www.10quality.com">
            <img src="<?php echo asset_url( '/../../../../images/10quality-logo-x65.png', __FILE__ )?>"
